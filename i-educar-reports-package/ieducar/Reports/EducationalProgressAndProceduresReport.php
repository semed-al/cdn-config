...
class EducationalProgressAndProceduresReport extends Portabilis_Report_ReportCore
{
    ...
    public function getSqlMainReport()
    {
        ...
        return "
            ...
            INNER JOIN pmieducar.escola ON (escola.ref_cod_instituicao = instituicao.cod_instituicao AND escola.situacao_funcionamento <> 3)
    ...
    public function getSqlsForDatasets()
    {
        ...
        $quantitativeChart = "
            ...
            ORDER BY CASE situacao
                WHEN 'Reprovado'   THEN 1
                WHEN 'Aprovado' THEN 2
                WHEN 'Transferido' THEN 3
                WHEN 'Falecido'    THEN 4
                WHEN 'Desistencia' THEN 5
                ELSE 6
            END
        ";
        return [
