...
trait ReportCardTraitWithSemesterRecovery
{
    /**
     * @inheritdoc
     */
    protected function query()
    {
        ...
        return <<<SQL
            SELECT fcn_upper(instituicao.nm_instituicao) AS nome_instituicao,
              ...
              nota_etapa1.nota_original::numeric(4,1) AS nota1num,
              nota_etapa2.nota_original AS nota2,
              nota_etapa2.nota_original::numeric(4,1) AS nota2num,              
              nota_etapa3.nota_original AS nota3,
              nota_etapa3.nota_original::numeric(4,1) AS nota3num,
              nota_etapa4.nota_original AS nota4,
              nota_etapa4.nota_original::numeric(4,1) AS nota4num,
              ROUND(
                  (nota_etapa1.nota_original::numeric + nota_etapa2.nota_original::numeric) / 2,
                  1
              ) AS media_parcial_semestre1,
              ROUND(
                  (nota_etapa3.nota_original::numeric + nota_etapa4.nota_original::numeric) / 2,
                  1
              ) AS media_parcial_semestre2,
              ROUND(
                COALESCE(nota_etapa2.nota_recuperacao_especifica, nota_etapa2.nota_recuperacao)::numeric, 1
              ) AS rec_semestre1,
              ROUND(
