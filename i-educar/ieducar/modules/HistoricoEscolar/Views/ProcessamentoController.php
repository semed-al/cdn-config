...
class ProcessamentoController extends Portabilis_Controller_Page_ListController
{
    ...
    public function Gerar()
    {
        ...
        $checked = true; 
        //in_array(config('legacy.report.mostrar_relatorios'), $usaCargaHorariaComponente);
        ...
        if ($this->validaControlePosicaoHistorico()) {
            $campoPosicao = '
            <tr class=\'tr_posicao\'>
                <td><label for=\'posicao\'>' . Portabilis_String_Utils::toUtf8('Posição') . ' *</label><br>
                <sub style=\'vertical-align:top;\'>' . Portabilis_String_Utils::toUtf8('Informe a coluna equivalente a série/ano/etapa a qual o histórico pertence. Ex.: 1º ano informe 1, 2º ano informe 2') . '</sub></td>
